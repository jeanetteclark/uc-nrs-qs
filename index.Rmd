...
This table shows the result of some preliminary cleaning of the free text answers. Answers were split by common delimiters (, ;), URL domains were extracted, and a couple of acronyms which commonly appeared both as the acronym and spelled out name were reconciled so that they were aggregated correctly. More work is likely needed to accurately capture every data sharing platform listed in the responses.
